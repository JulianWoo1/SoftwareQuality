...
public class PresentationService {
  ...
  public PresentationService(
      Presentation presentation, PresentationSerializer serializer, JFrame frame) {
  ...
  public void open() {
    ...
    if (chooser.showOpenDialog(frame) == JFileChooser.APPROVE_OPTION) {
      try {
        ...
        serializer.loadToPresentation(chooser.getSelectedFile().getAbsolutePath(), presentation);
      } catch (Exception e) {
  ...
  public void save() {
    ...
    if (chooser.showSaveDialog(frame) == JFileChooser.APPROVE_OPTION) {
      try {
        serializer.saveFromPresentation(chooser.getSelectedFile().getAbsolutePath(), presentation);
      } catch (Exception e) {
        JOptionPane.showMessageDialog(frame, e.getMessage());
      }
    }
